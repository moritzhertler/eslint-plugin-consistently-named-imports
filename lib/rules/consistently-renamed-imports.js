...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            url: "https://github.com/moritzhertler/eslint-plugin-consistently-renamed-imports/blob/main/docs/rules/consistently-renamed-imports.md",
        },
